...
export const {
  ...
  setAddAdvertPhoneOpen,
  setAddAdvertPhoneError,
  setAddAdvertPhoneSuccess,
  setAddAdvertPhoneLoading,
  setAddAdvertSubCategoryText,
  setAddAdvertLoading,
  setNewAdvertData,
...
export const addAdvertThunk = (data, category, lang) => async dispatch => {
  ...
  await AddAdvertApi.createAdvert(data, category, lang).then(advert => {
