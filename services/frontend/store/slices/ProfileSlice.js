...
export const {
  setProfileCurrencyOpen,
  setProfileLanguageOpen,
  setProfileData,
  setProfileEditingLoading,
  setProfileEditingSuccess,
  setProfileEditingActivated,
  setUserAdverts,
  setDeletingOpen,
  setDeletingLoading,
  setProfileChangeResendEmail,
...
export const editUserDataThunk =
  ({ email, name, city, avatar, phone }) =>
  async dispatch => {
