            ...
            <div className="categories-choice categories-choice--height">
...

                {
                    category === 'realty' && <>
                        ...
                        <SubCategoryInput {...{text: 'land', value: 'Land', categoryName: 'Real estate', category: 'realty_land'}} />
                        <SubCategoryInput {...{text: 'Commercial', value: 'Commercial', categoryName: 'Real estate', category: 'realty'}} />
                        <SubCategoryInput {...{text: 'Other', value: 'Other', categoryName: 'Real estate', category: 'realty_land'}} style={{borderBottom: 'none'}} />
                    </>
                }
                {
                    category === 'avto' && <>
