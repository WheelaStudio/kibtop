  ...
  return (
    <>
      {!!isOpen && (
        <>
          <div
            className="modal-screen modal-screen--favorites modal-screen--phone"
            {...swipe}>
              ...
              {isSuccess ? (
                ...
                <>
                  <h4 className="title modal-title">
                    <Text content={"Add your phone number"} />
                  </h4>
                  <p className="greeting__text modal-text">
                    <Text
                      content={
                        "In order for customers to contact you, we need your phone number"
                      }
                    />
                  </p>
          ...
          <div
            className="screen-dimmer screen-dimmer--location"
