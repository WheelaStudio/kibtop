...
const CityField = () => {
  ...
  return (
    <>
      <div
        className={"form__field" + (isError ? " form__field--error" : "")}
        ...
        />
        <a className="use-location" onClick={setCityInputLocation}>
          <Text content="Use my location" />
        </a>
      </div>
    </>
  );
