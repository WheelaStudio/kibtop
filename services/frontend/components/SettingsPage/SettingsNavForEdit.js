    ...
    <>
      <div className="container">
        <nav className="settings-nav">
          ...
          <h1 className="title title--settings">
            <Text content={title} />
          </h1>
        </nav>
      </div>
