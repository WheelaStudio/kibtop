      ...
      <div className="advert">
        ...
        <div className="advert__desc">
          <div className="advert__column">
            <h5 className="advert-title">{title}</h5>

            <p className="advert-cost advert-cost--desk">
              <span style={{ fontWeight: 600 }}>{cur.currency}</span>
              {cur.countCurrencyPrice(cost, currency)}
            </p>
          </div>
          ...
          <div className="advert__column advert__column--right">
            ...
            <p className="advert-cost advert-cost--mob">
              {cur.currency}
              {cur.countCurrencyPrice(cost, currency)}
            </p>
