    ...
    <>
      <Head>
        ...
        <link
          rel="alternate"
          hreflang="ru"
          href={`https://kibtop.com/ru/adverts/${category}/`}
        />
        <link
          rel="alternate"
          hreflang="en"
          href={`https://kibtop.com/adverts/${category}/`}
        />
        <link
          rel="alternate"
          hreflang="tr"
          href={`https://kibtop.com/tr/adverts/${category}/`}
        />
        <link
          rel="alternate"
          hreflang="x-default"
...
export async function getServerSideProps({ req, res, locale, query }) {
  ...
  const { adverts, pages } = await CategoryApi.getCategoryAdverts(
    category,
    locale,
    page,
    query
